...
# # Seahorn
# time timeout 300 sea yama -y sea.yaml bpf $1.mlir.opt.ll --bound=20 --v=1
# echo "sea yama -y sea.json bpf $1.mlir.opt.ll --bound=20"

# # VCGen
# time timeout 300 sea yama -y sea.yaml bnd-smt $1.mlir.opt.ll -o$1.mlir.opt.ll.smt2 --oll=$1.mlir.opt.ll.final --bound=20

# # exe-cex
# # --oll=$1.mlir.opt.ll.final.ll
# time timeout 300 sea yama -y sea-cex.yaml bpf  --verbose=2 --cex=/tmp/h2.ll --log=cex -m64 --keep-temps --temp-dir=/tmp/cex $1.mlir.opt.ll -o$1.mlir.opt.ll.smt2 --bound=20
