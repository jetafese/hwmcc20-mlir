...
echo "$(python scrabber.py sims/btorsim_array_18A_wolf_02282402 -o sims/btorsim_array_18A.csv)";\
echo "$(python scrabber.py sims/btorsim_array_19A_wolf_02282402 -o sims/btorsim_array_19A.csv)";\
echo "$(python scrabber.py sims/btorsim_array_19B_wolf_02282402 -o sims/btorsim_array_19B.csv)";\
echo "$(python scrabber.py sims/btorsim_array_19C_wolf_02282402 -o sims/btorsim_array_19C.csv)";\
echo "$(python scrabber.py sims/btorsim_array_19_mann_02282402 -o sims/btorsim_array_19_mann.csv)";\
echo "$(python scrabber.py sims/btorsim_array_20_mann_02282402 -o sims/btorsim_array_20_mann.csv)";\
