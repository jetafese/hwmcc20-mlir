...
define void @main() !dbg !3 {
  ...
  %130 = trunc i8 %128 to i1, !dbg !191
...
211:                                              ; preds = %999, %0
  ...
  %259 = phi i1 [ %835, %999 ], [ false, %0 ]
  %260 = phi i1 [ %836, %999 ], [ %130, %0 ]
  ...
  %831 = bitcast i4 %426 to <4 x i1>, !dbg !854
  %832 = call i1 @llvm.vector.reduce.or.v4i1(<4 x i1> %831), !dbg !855
  %833 = xor i1 %832, true, !dbg !856
  %834 = and i1 %317, %833, !dbg !857
  %835 = select i1 %834, i1 true, i1 false, !dbg !858
  %836 = or i1 %827, %830, !dbg !859
  ...
  %996 = xor i1 %260, true, !dbg !1062
  %997 = and i1 %259, %996, !dbg !1063
...
!4 = !DIFile(filename: "btor2/array/2019/wolf/2018A/zipcpu-zipmmu-p00.btor.mlir.opt", directory: "/home/jetafese/hwmc20-mlir")
...
!856 = !DILocation(line: 1424, column: 13, scope: !8)
