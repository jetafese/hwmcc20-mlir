...
1:                                                ; preds = %45, %0
  %2 = phi i256 [ %16, %45 ], [ 0, %0 ]
  %3 = phi i256 [ %22, %45 ], [ 0, %0 ]
  %4 = phi i128 [ %28, %45 ], [ 0, %0 ]
  %5 = phi i128 [ %34, %45 ], [ 0, %0 ]
  %6 = phi i1 [ %35, %45 ], [ true, %0 ]
  %7 = phi i1 [ %36, %45 ], [ true, %0 ]
  %8 = phi i128 [ %38, %45 ], [ 0, %0 ]
  %9 = phi i128 [ %40, %45 ], [ 0, %0 ]
  ...
  %16 = select i1 %15, i256 0, i256 %12, !dbg !16
  %17 = zext i128 %9 to i256, !dbg !17
  %18 = zext i128 %8 to i256, !dbg !18
  %19 = mul i256 %18, %17, !dbg !19
  %20 = or i1 %6, %7, !dbg !20
  %21 = select i1 %20, i256 %19, i256 %3, !dbg !21
  %22 = select i1 %15, i256 0, i256 %21, !dbg !22
  %23 = call i128 @nd_bv128_in3(), !dbg !23
  %24 = call i8 @nd_bv8_in1(), !dbg !24
  %25 = zext i8 %24 to i64, !dbg !25
  call void @btor2mlir_print_input_num(i64 1, i64 %25, i64 1), !dbg !26
  %26 = trunc i8 %24 to i1, !dbg !27
  %27 = select i1 %26, i128 %23, i128 %4, !dbg !28
  %28 = select i1 %15, i128 0, i128 %27, !dbg !29
  %29 = call i128 @nd_bv128_in4(), !dbg !30
  %30 = call i8 @nd_bv8_in2(), !dbg !31
  %31 = zext i8 %30 to i64, !dbg !32
  call void @btor2mlir_print_input_num(i64 2, i64 %31, i64 1), !dbg !33
  %32 = trunc i8 %30 to i1, !dbg !34
  %33 = select i1 %32, i128 %29, i128 %5, !dbg !35
  %34 = select i1 %15, i128 0, i128 %33, !dbg !36
  %35 = select i1 %15, i1 true, i1 %26, !dbg !37
  %36 = select i1 %15, i1 true, i1 %32, !dbg !38
  %37 = select i1 %26, i128 %23, i128 %8, !dbg !39
  %38 = select i1 %15, i128 0, i128 %37, !dbg !40
  %39 = select i1 %32, i128 %29, i128 %9, !dbg !41
  %40 = select i1 %15, i128 0, i128 %39, !dbg !42
  %41 = icmp eq i256 %2, %3, !dbg !43
  %42 = xor i1 %41, true, !dbg !44
  %43 = and i1 true, %42, !dbg !45
  %44 = xor i1 %43, true, !dbg !46
  br i1 %44, label %45, label %46, !dbg !47
...
!4 = !DIFile(filename: "btor2/bv/2019/goel/mul3.btor2.mlir.opt", directory: "/home/jetafese/hwmc20-mlir")
...
!48 = !DILocation(line: 71, column: 5, scope: !8)
!49 = !DILocation(line: 73, column: 5, scope: !8)
!50 = !DILocation(line: 74, column: 5, scope: !8)
