module {
  ...
  ^bb1(%17: i64, %18: i5, %19: i64, %20: i64, %21: i64, %22: i64, %23: i64, %24: i64, %25: i64, %26: i64, %27: i5, %28: i1, %29: i1, %30: i5, %31: i64, %32: i1, %33: i5):  // 2 preds: ^bb0, ^bb1
    ...
    %42 = btor.ite %41, %34, %17 : i64
    %43 = btor.constant 0 : i64
    %44 = btor.input 4 : i1
    %45 = btor.ite %44, %43, %42 : i64
    %46 = btor.input 2 : i1
    ...
    %136 = btor.ite %135, %34, %31 : i64
    %137 = btor.ite %44, %43, %136 : i64
    ...
    btor.assert_not(%197)
    br ^bb1(%45, %53, %59, %65, %71, %77, %83, %89, %95, %100, %105, %112, %129, %134, %137, %111, %141 : i64, i5, i64, i64, i64, i64, i64, i64, i64, i64, i5, i1, i1, i5, i64, i1, i5)
  }
}
