module {
  ...
  ^bb1(%14: i32, %15: i4, %16: i1, %17: i1, %18: i4, %19: i32, %20: i1, %21: i32, %22: i32, %23: i32, %24: i32, %25: i32, %26: i32, %27: i32):  // 2 preds: ^bb0, ^bb1
    ...
    %39 = btor.ite %38, %31, %30 : i32
    %40 = btor.redor %15 : i4
    %41 = btor.not %40 : i1
    %42 = btor.and %37, %41 : i1
    %43 = btor.or %29, %42 : i1
    %44 = btor.ite %43, %39, %14 : i32
    %45 = btor.input 5 : i1
    %46 = btor.ite %45, %28, %44 : i32
    ...
    btor.assert_not(%197)
    br ^bb1(%46, %52, %59, %77, %82, %85, %58, %96, %108, %120, %132, %144, %156, %164 : i32, i4, i1, i1, i4, i32, i1, i32, i32, i32, i32, i32, i32, i32)
  }
}
