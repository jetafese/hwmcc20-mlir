...
78:                                               ; preds = %699, %0
  ...
  %677 = trunc i22 %676 to i19, !dbg !714
  %678 = lshr i22 %83, 19, !dbg !715
  %679 = trunc i22 %678 to i1, !dbg !716
  %680 = xor i1 %679, true, !dbg !717
  %681 = zext i1 %680 to i20, !dbg !718
  %682 = shl i20 %681, 19, !dbg !719
  %683 = zext i19 %677 to i20, !dbg !720
  %684 = or i20 %682, %683, !dbg !721
  %685 = lshr i22 %83, 20, !dbg !722
  %686 = trunc i22 %685 to i2, !dbg !723
  %687 = zext i2 %686 to i22, !dbg !724
  %688 = shl i22 %687, 20, !dbg !725
  %689 = zext i20 %684 to i22, !dbg !726
...
!4 = !DIFile(filename: "btor2/bv/2019/wolf/2019C/qspiflash_qflexpress_divfive-p063.btor.mlir.opt", directory: "/home/jetafese/hwmc20-mlir")
