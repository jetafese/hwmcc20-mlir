...
78:                                               ; preds = %813, %0
  ...
  %163 = xor i1 %160, true, !dbg !172
  %164 = and i1 %161, %163, !dbg !173
  %165 = lshr i6 %80, 0, !dbg !174
  %166 = trunc i6 %165 to i5, !dbg !175
  %167 = zext i5 %166 to i6, !dbg !176
  %168 = or i6 0, %167, !dbg !177
  %169 = lshr i6 %80, 0, !dbg !178
  %170 = trunc i6 %169 to i5, !dbg !179
  %171 = zext i5 %170 to i6, !dbg !180
  %172 = shl i6 %171, 1, !dbg !181
  %173 = or i6 %172, 0, !dbg !182
  %174 = select i1 %95, i6 %173, i6 %168, !dbg !183
  %175 = lshr i6 %174, 0, !dbg !184
  %176 = trunc i6 %175 to i1, !dbg !185
  %177 = or i1 %176, %164, !dbg !186
  %178 = lshr i6 %174, 1, !dbg !187
  %179 = trunc i6 %178 to i5, !dbg !188
  %180 = zext i5 %179 to i6, !dbg !189
  %181 = shl i6 %180, 1, !dbg !190
  %182 = zext i1 %177 to i6, !dbg !191
  %183 = or i6 %181, %182, !dbg !192
  %184 = select i1 %157, i6 0, i6 %183, !dbg !193
...
!4 = !DIFile(filename: "btor2/bv/2019/wolf/2019C/qspiflash_dualflexpress_divthree-p085.btor.mlir.opt", directory: "/home/jetafese/hwmc20-mlir")
...
!184 = !DILocation(line: 376, column: 12, scope: !8)
...
!189 = !DILocation(line: 383, column: 12, scope: !8)
!190 = !DILocation(line: 384, column: 12, scope: !8)
