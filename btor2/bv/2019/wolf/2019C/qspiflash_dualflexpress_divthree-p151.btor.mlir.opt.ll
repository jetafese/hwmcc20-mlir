...
78:                                               ; preds = %750, %0
  ...
  %728 = trunc i38 %727 to i33, !dbg !764
  %729 = lshr i38 %83, 33, !dbg !765
  %730 = trunc i38 %729 to i1, !dbg !766
  %731 = xor i1 %730, true, !dbg !767
  %732 = zext i1 %731 to i34, !dbg !768
  %733 = shl i34 %732, 33, !dbg !769
  %734 = zext i33 %728 to i34, !dbg !770
  %735 = or i34 %733, %734, !dbg !771
  %736 = lshr i38 %83, 34, !dbg !772
  %737 = trunc i38 %736 to i4, !dbg !773
  %738 = zext i4 %737 to i38, !dbg !774
  %739 = shl i38 %738, 34, !dbg !775
  %740 = zext i34 %735 to i38, !dbg !776
...
!4 = !DIFile(filename: "btor2/bv/2019/wolf/2019C/qspiflash_dualflexpress_divthree-p151.btor.mlir.opt", directory: "/home/jetafese/hwmc20-mlir")
