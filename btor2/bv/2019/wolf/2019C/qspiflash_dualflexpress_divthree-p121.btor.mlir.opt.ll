...
78:                                               ; preds = %750, %0
  ...
  %730 = trunc i38 %729 to i5, !dbg !766
  %731 = xor i1 %268, true, !dbg !767
  %732 = zext i1 %731 to i6, !dbg !768
  %733 = shl i6 %732, 5, !dbg !769
  %734 = zext i5 %730 to i6, !dbg !770
  %735 = or i6 %733, %734, !dbg !771
  %736 = lshr i38 %83, 6, !dbg !772
  %737 = trunc i38 %736 to i32, !dbg !773
  %738 = zext i32 %737 to i38, !dbg !774
  %739 = shl i38 %738, 6, !dbg !775
  %740 = zext i6 %735 to i38, !dbg !776
...
!4 = !DIFile(filename: "btor2/bv/2019/wolf/2019C/qspiflash_dualflexpress_divthree-p121.btor.mlir.opt", directory: "/home/jetafese/hwmc20-mlir")
