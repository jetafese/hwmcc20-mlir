...
78:                                               ; preds = %750, %0
  ...
  %730 = trunc i38 %729 to i4, !dbg !766
  %731 = xor i1 %268, true, !dbg !767
  %732 = zext i1 %731 to i5, !dbg !768
  %733 = shl i5 %732, 4, !dbg !769
  %734 = zext i4 %730 to i5, !dbg !770
  %735 = or i5 %733, %734, !dbg !771
  %736 = lshr i38 %83, 5, !dbg !772
  %737 = trunc i38 %736 to i33, !dbg !773
  %738 = zext i33 %737 to i38, !dbg !774
  %739 = shl i38 %738, 5, !dbg !775
  %740 = zext i5 %735 to i38, !dbg !776
...
!4 = !DIFile(filename: "btor2/bv/2019/wolf/2019C/qspiflash_dualflexpress_divthree-p032.btor.mlir.opt", directory: "/home/jetafese/hwmc20-mlir")
