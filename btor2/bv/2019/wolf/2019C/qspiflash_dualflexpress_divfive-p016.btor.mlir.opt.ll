...
78:                                               ; preds = %713, %0
  ...
  %83 = phi i1 [ %244, %713 ], [ true, %0 ]
  %84 = phi i1 [ %247, %713 ], [ false, %0 ]
  %85 = phi i2 [ %262, %713 ], [ 0, %0 ]
  %86 = phi i1 [ %263, %713 ], [ false, %0 ]
  %87 = phi i1 [ %264, %713 ], [ false, %0 ]
  %88 = phi i1 [ %277, %713 ], [ false, %0 ]
  %89 = phi i6 [ %285, %713 ], [ 0, %0 ]
  %90 = phi i6 [ %289, %713 ], [ 0, %0 ]
  %91 = phi i1 [ %291, %713 ], [ false, %0 ]
  %92 = phi i1 [ %299, %713 ], [ false, %0 ]
  %93 = phi i1 [ %301, %713 ], [ false, %0 ]
  %94 = phi i2 [ %716, %713 ], [ %3, %0 ]
  %95 = phi i2 [ %94, %713 ], [ %6, %0 ]
  %96 = phi i1 [ %80, %713 ], [ %9, %0 ]
  %97 = phi i34 [ %530, %713 ], [ 0, %0 ]
  %98 = phi i1 [ %532, %713 ], [ %12, %0 ]
  ...
  %105 = phi i1 [ %280, %713 ], [ %30, %0 ]
  %106 = phi i32 [ %112, %713 ], [ %31, %0 ]
  %107 = phi i22 [ %304, %713 ], [ %35, %0 ]
  %108 = phi i3 [ %547, %713 ], [ -3, %0 ]
  %109 = phi i22 [ %549, %713 ], [ %38, %0 ]
  %110 = phi i1 [ %573, %713 ], [ false, %0 ]
  %111 = phi i1 [ %575, %713 ], [ false, %0 ]
  ...
  %707 = icmp ult i6 -16, %81, !dbg !744
  %708 = select i1 %707, i1 %145, i1 true, !dbg !745
...
!4 = !DIFile(filename: "btor2/bv/2019/wolf/2019C/qspiflash_dualflexpress_divfive-p016.btor.mlir.opt", directory: "/home/jetafese/hwmc20-mlir")
...
!757 = !DILocation(line: 1152, column: 5, scope: !8)
!758 = !DILocation(line: 1153, column: 5, scope: !8)
!759 = !DILocation(line: 1155, column: 5, scope: !8)
!760 = !DILocation(line: 1156, column: 5, scope: !8)
