...
78:                                               ; preds = %746, %0
  %79 = phi i1 [ %145, %746 ], [ false, %0 ]
  %80 = phi i1 [ %169, %746 ], [ true, %0 ]
  %81 = phi i6 [ %213, %746 ], [ 0, %0 ]
  %82 = phi i1 [ %220, %746 ], [ true, %0 ]
  %83 = phi i38 [ %241, %746 ], [ 0, %0 ]
  %84 = phi i1 [ %266, %746 ], [ true, %0 ]
  %85 = phi i1 [ %269, %746 ], [ false, %0 ]
  %86 = phi i2 [ %284, %746 ], [ 0, %0 ]
  %87 = phi i1 [ %285, %746 ], [ false, %0 ]
  %88 = phi i1 [ %286, %746 ], [ false, %0 ]
  %89 = phi i1 [ %299, %746 ], [ false, %0 ]
  %90 = phi i6 [ %307, %746 ], [ 0, %0 ]
  %91 = phi i6 [ %311, %746 ], [ 0, %0 ]
  %92 = phi i1 [ %313, %746 ], [ false, %0 ]
  %93 = phi i1 [ %321, %746 ], [ false, %0 ]
  %94 = phi i1 [ %323, %746 ], [ false, %0 ]
  %95 = phi i2 [ %749, %746 ], [ %3, %0 ]
  %96 = phi i2 [ %95, %746 ], [ %6, %0 ]
  %97 = phi i1 [ %80, %746 ], [ %9, %0 ]
  %98 = phi i34 [ %552, %746 ], [ 0, %0 ]
  %99 = phi i1 [ %554, %746 ], [ %12, %0 ]
  %100 = phi i1 [ true, %746 ], [ false, %0 ]
  %101 = phi i1 [ %137, %746 ], [ %15, %0 ]
  %102 = phi i1 [ %129, %746 ], [ %18, %0 ]
  %103 = phi i1 [ %84, %746 ], [ %21, %0 ]
  %104 = phi i1 [ %150, %746 ], [ %24, %0 ]
  %105 = phi i1 [ %125, %746 ], [ %27, %0 ]
  %106 = phi i1 [ %302, %746 ], [ %30, %0 ]
  %107 = phi i32 [ %113, %746 ], [ %31, %0 ]
  %108 = phi i22 [ %326, %746 ], [ %35, %0 ]
  %109 = phi i3 [ %569, %746 ], [ -3, %0 ]
  %110 = phi i22 [ %571, %746 ], [ %38, %0 ]
  %111 = phi i1 [ %595, %746 ], [ false, %0 ]
  %112 = phi i1 [ %597, %746 ], [ false, %0 ]
  ...
  %732 = lshr i38 %83, 1, !dbg !768
  %733 = trunc i38 %732 to i37, !dbg !769
  %734 = zext i37 %733 to i38, !dbg !770
  %735 = shl i38 %734, 1, !dbg !771
  %736 = zext i1 %731 to i38, !dbg !772
  %737 = or i38 %735, %736, !dbg !773
  %738 = bitcast i38 %737 to <38 x i1>, !dbg !774
  %739 = call i1 @llvm.vector.reduce.or.v38i1(<38 x i1> %738), !dbg !775
  %740 = xor i1 %739, true, !dbg !776
  %741 = select i1 %730, i1 %740, i1 true, !dbg !777
  %742 = xor i1 %741, true, !dbg !778
  %743 = xor i1 %741, true, !dbg !779
  %744 = and i1 %743, %742, !dbg !780
  %745 = xor i1 %744, true, !dbg !781
  br i1 %745, label %746, label %752, !dbg !782

746:                                              ; preds = %78
  %747 = call i8 @nd_bv8_st207(), !dbg !783
  %748 = zext i8 %747 to i64, !dbg !784
  call void @btor2mlir_print_state_num(i64 207, i64 %748, i64 2), !dbg !785
  %749 = trunc i8 %747 to i2, !dbg !786
  %750 = call i16 @nd_bv16_st242(), !dbg !787
  %751 = zext i16 %750 to i64, !dbg !788
  call void @btor2mlir_print_state_num(i64 242, i64 %751, i64 15), !dbg !789
  br label %78, !dbg !790
...
!4 = !DIFile(filename: "btor2/bv/2019/wolf/2019C/qspiflash_dualflexpress_divfive-p074.btor.mlir.opt", directory: "/home/jetafese/hwmc20-mlir")
...
!768 = !DILocation(line: 1167, column: 13, scope: !8)
...
!774 = !DILocation(line: 1174, column: 13, scope: !8)
!775 = !DILocation(line: 1175, column: 13, scope: !8)
!776 = !DILocation(line: 1177, column: 13, scope: !8)
...
!780 = !DILocation(line: 1183, column: 13, scope: !8)
!781 = !DILocation(line: 1185, column: 13, scope: !8)
!782 = !DILocation(line: 1186, column: 5, scope: !8)
...
!787 = !DILocation(line: 1195, column: 13, scope: !8)
!788 = !DILocation(line: 1199, column: 13, scope: !8)
!789 = !DILocation(line: 1200, column: 5, scope: !8)
!790 = !DILocation(line: 1201, column: 5, scope: !8)
!791 = !DILocation(line: 1203, column: 5, scope: !8)
!792 = !DILocation(line: 1204, column: 5, scope: !8)
