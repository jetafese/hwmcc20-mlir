...
78:                                               ; preds = %791, %0
  ...
  %84 = phi i1 [ %308, %791 ], [ false, %0 ]
  %85 = phi i1 [ %309, %791 ], [ false, %0 ]
  ...
  %253 = lshr i10 %79, 8, !dbg !261
  %254 = trunc i10 %253 to i1, !dbg !262
  %255 = lshr i10 %79, 7, !dbg !263
  %256 = trunc i10 %255 to i1, !dbg !264
  %257 = lshr i10 %79, 6, !dbg !265
  %258 = trunc i10 %257 to i1, !dbg !266
  %259 = zext i1 %258 to i2, !dbg !267
  %260 = shl i2 %259, 1, !dbg !268
  %261 = zext i1 %256 to i2, !dbg !269
  %262 = or i2 %260, %261, !dbg !270
  %263 = lshr i10 %79, 5, !dbg !271
  %264 = trunc i10 %263 to i1, !dbg !272
  %265 = zext i1 %264 to i3, !dbg !273
  %266 = shl i3 %265, 2, !dbg !274
  %267 = zext i2 %262 to i3, !dbg !275
  %268 = or i3 %266, %267, !dbg !276
  %269 = lshr i10 %79, 4, !dbg !277
  %270 = trunc i10 %269 to i1, !dbg !278
  %271 = zext i1 %270 to i4, !dbg !279
  %272 = shl i4 %271, 3, !dbg !280
  %273 = zext i3 %268 to i4, !dbg !281
  %274 = or i4 %272, %273, !dbg !282
  %275 = lshr i10 %79, 3, !dbg !283
  %276 = trunc i10 %275 to i1, !dbg !284
  %277 = zext i1 %276 to i5, !dbg !285
  %278 = shl i5 %277, 4, !dbg !286
  %279 = zext i4 %274 to i5, !dbg !287
  %280 = or i5 %278, %279, !dbg !288
  %281 = lshr i10 %79, 2, !dbg !289
  %282 = trunc i10 %281 to i1, !dbg !290
  %283 = zext i1 %282 to i6, !dbg !291
  %284 = shl i6 %283, 5, !dbg !292
  %285 = zext i5 %280 to i6, !dbg !293
  %286 = or i6 %284, %285, !dbg !294
  %287 = lshr i10 %79, 1, !dbg !295
  %288 = trunc i10 %287 to i1, !dbg !296
  %289 = zext i1 %288 to i7, !dbg !297
  %290 = shl i7 %289, 6, !dbg !298
  %291 = zext i6 %286 to i7, !dbg !299
  %292 = or i7 %290, %291, !dbg !300
  %293 = lshr i10 %79, 0, !dbg !301
  %294 = trunc i10 %293 to i1, !dbg !302
  %295 = zext i1 %294 to i8, !dbg !303
  %296 = shl i8 %295, 7, !dbg !304
  %297 = zext i7 %292 to i8, !dbg !305
  %298 = or i8 %296, %297, !dbg !306
  %299 = bitcast i8 %298 to <8 x i1>, !dbg !307
  %300 = call i1 @llvm.vector.reduce.or.v8i1(<8 x i1> %299), !dbg !308
  %301 = and i1 %300, %254, !dbg !309
  %302 = lshr i32 %115, 0, !dbg !310
  %303 = trunc i32 %302 to i1, !dbg !311
  %304 = lshr i34 %100, 32, !dbg !312
  %305 = trunc i34 %304 to i1, !dbg !313
  %306 = xor i1 %305, %303, !dbg !314
  %307 = xor i1 %306, true, !dbg !315
  %308 = select i1 %301, i1 %307, i1 true, !dbg !316
  %309 = xor i1 %308, true, !dbg !317
  %310 = icmp eq i6 %82, 2, !dbg !318
  %311 = and i1 %114, %173, !dbg !319
  %312 = and i1 %311, %113, !dbg !320
  %313 = and i1 %312, %252, !dbg !321
  %314 = select i1 %313, i1 false, i1 %86, !dbg !322
  %315 = and i1 %312, %310, !dbg !323
...
!4 = !DIFile(filename: "btor2/bv/2019/wolf/2019C/qspiflash_dualflexpress_divfive-p116.btor.mlir.opt", directory: "/home/jetafese/hwmc20-mlir")
