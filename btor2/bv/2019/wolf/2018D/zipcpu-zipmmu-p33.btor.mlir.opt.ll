...
define void @main() !dbg !3 {
  ...
  %161 = trunc i8 %159 to i1, !dbg !236
...
247:                                              ; preds = %971, %0
  ...
  %303 = phi i1 [ %798, %971 ], [ %161, %0 ]
  %304 = phi i1 [ %803, %971 ], [ false, %0 ]
  ...
  %798 = or i1 %792, %797, !dbg !826
  %799 = bitcast i4 %481 to <4 x i1>, !dbg !827
  %800 = call i1 @llvm.vector.reduce.or.v4i1(<4 x i1> %799), !dbg !828
  %801 = xor i1 %800, true, !dbg !829
  %802 = and i1 %362, %801, !dbg !830
  ...
  %968 = xor i1 %303, true, !dbg !1039
  %969 = and i1 %304, %968, !dbg !1040
...
!4 = !DIFile(filename: "btor2/bv/2019/wolf/2018D/zipcpu-zipmmu-p33.btor.mlir.opt", directory: "/home/jetafese/hwmc20-mlir")
